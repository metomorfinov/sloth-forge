> ⚠️ **Пометка от 13.09.2026 (полный аудит кода, ветка `fix/stage1-honest-api`).**
> Выводы этого отчёта не подтвердились: описанное здесь «исправление» размеров вариантов
> по-прежнему угадывало размеры по названию репозитория, а многие «работающие» эндпоинты
> были заглушками. Все эти места переписаны в коммитах этапа 1; актуальное состояние —
> в заметке Obsidian «SlothForge Hub». Файл сохранён как исторический.
