...
pub fn create_router(state: Arc<AppState>, static_dir: Option<PathBuf>) -> Router {
    ...
    let api_router = Router::new()
        ...
        .route("/hub/delete-impact", get(hub::handle_hub_delete_impact).post(hub::handle_hub_delete_impact))
        ...
        .route("/chat/threads/:id/messages", get(api::handle_chat_thread_messages).post(api::handle_chat_thread_messages_post).put(api::handle_chat_thread_messages_post))
        .route("/chat/threads/:id/messages/:msg_id", put(api::handle_chat_thread_message_detail_put))
