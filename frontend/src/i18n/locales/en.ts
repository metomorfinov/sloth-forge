...
export const en = {
  ...
  settings: {
    ...
    dialog: {
      title: "Settings",
      description: "Manage your SlothForge preferences.",
    ...
    keyboardShortcuts: {
      ...
      actions: {
        ...
        logOut: {
          label: "Log out",
          description: "Sign out of SlothForge",
        },
        approveToolRequest: {
    ...
    voice: {
      ...
      dictation: {
        ...
        micAccessBlocked:
          "Microphone access was blocked. Allow microphone access for this SlothForge page, then try again.",
    ...
    general: {
      title: "General",
      description: "Global preferences for SlothForge.",
      account: "Account",
      ...
      password: "Password",
      passwordDescription: "Change the password for this SlothForge account.",
      passwordDialog: {
        ...
        setDescription:
          "Choose the password remote browsers sign in with as unsloth (at least {minLength} characters). The SlothForge Desktop App keeps signing in automatically.",
      ...
      modelAutoSwitch: {
        ...
        apiOnlyDescription:
          "Idle unload leaves a model you loaded from SlothForge in memory, and frees only the ones an API request loaded.",
      },
      previewSharing: {
      ...
      permissions: {
        ...
        bypassDescription:
          "How SlothForge approves chat tool calls (terminal, python, web, MCP) before they run. Full access disables approvals and the code sandbox.",
      },
      notifications: {
      ...
      startup: {
        ...
        launchAtLogin: "Run SlothForge at login",
        launchAtLoginDescription:
          "Start SlothForge in the background when you log in. It stays in the menu bar or system tray until you open it.",

        closeToTray: "Close to system tray",
        closeToTrayDescription:
          "Keep SlothForge and its server running in the background when you close the main window.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Clears local-only preferences and reloads SlothForge. Chats, API access, and DB-backed settings are kept.",
        confirmAction: "Reset and reload",
      },
    },
    profile: {
      title: "Profile",
      description: "How your profile appears in SlothForge.",
      changePicture: "Change profile picture",
      uploadPhoto: "Upload photo",
      removePhoto: "Remove",
      pictureOptions: "Profile picture options",
      displayName: "Display name",
      nickname: "What should SlothForge call you?",
      ...
      stats: {
        title: "Your stats",
        subtitle:
          "Everything below is counted from your own history. Nothing is collected or sent to SlothForge.",
        retry: "Try again",
        privacyNote:
          "Stats are computed from local chat, API usage, and training history held by your SlothForge install. API prompts, responses, and keys are never stored for stats. Nothing is sent to SlothForge or any third party.",
        emptyChats:
        ...
        studioChatTokens: "SlothForge Chat tokens",
    ...
    appearance: {
      title: "Appearance",
      description: "How SlothForge looks on this device.",
      theme: {
        title: "Theme",
        label: "Color scheme",
      ...
      palette: {
        label: "Color palette",
        description: "Colors used across SlothForge, in light and dark mode.",
        standard: "Standard",
        classic: "Classic",
        minimal: "Minimal",
      },
      custom: {
        ...
        uiFontSize: {
          label: "UI font size",
          description: "Adjust the base size used for the SlothForge UI.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "The language used by SlothForge.",
    ...
    resources: {
      title: "System",
      description: "Monitor this SlothForge server's hardware and storage.",
      ...
      llamaBackend: {
        ...
        customPath: {
          ...
          bundled: "Uses the llama.cpp runtime installed by SlothForge.",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp is a local directory you linked yourself, so SlothForge will not replace it.",
    ...
    agents: {
      ...
      intro:
        "connects Claude Code, Codex, DeepSeek Harness, Hermes, OpenClaw, OpenCode and other agents to a model served locally by SlothForge, fully offline. It runs an OpenAI-compatible server and never touches your agent's config files.",
      ...
      modelNote:
        "Codex requires a GGUF model served by llama-server. Other agents can also use transformer-backed models; remove --model to use the model already loaded in SlothForge.",
      subagent: {
        title: "Use a local model as a subagent",
        description:
          "Keep {agent} on its current model and delegate selected tasks to this local SlothForge model.",
      ...
      quickstart: {
        ...
        description:
          "Launch an agent against the model currently loaded in SlothForge. Load a model first, then swap claude for any supported agent below.",
      ...
      options: {
        ...
        description:
          "SlothForge flags are parsed first; anything it doesn't recognize is passed straight through to the agent.",
        model:
          "Select a model. Without --model, unsloth start uses the model currently loaded in SlothForge and errors if none is loaded.",
        contextLength:
        ...
        persist: "Keep SlothForge-managed agent storage between runs.",
        asSubagent:
          "Keep the parent on its current model and register SlothForge as a local subagent (Claude Code, Codex, and OpenCode).",
        apiKey: "Provide your SlothForge API key (or set UNSLOTH_API_KEY).",
        reasoning:
      ...
      remote: {
        title: "Connect to a remote SlothForge Studio",
        description:
          "Point unsloth start at a SlothForge Studio running elsewhere by setting these before launching (or pass --api-key directly):",
      },
      passthrough: {
        title: "Passing agent arguments",
        description:
          "Arguments after the SlothForge flags are forwarded to the agent itself, so native commands like resume still work:",
      },
      dryRun: {
    ...
    chat: {
      ...
      webSearch: {
        ...
        imagesDescription:
          "Let web search return pictures, and fetch one for each thing an answer lists. Thumbnails are downloaded and resized by SlothForge, so the browser never contacts image hosts.",
      },
      artifacts: {
        title: "Canvas",
    ...
    remoteLan: {
      title: "Remote & LAN",
      description:
        "Reach this SlothForge from your other devices, over your local network or a temporary public URL.",
    },
    apiKeys: {
      title: "API",
      description: "Access SlothForge via the OpenAI-compatible API.",
      ...
      secureHttpsHint:
        "The 0.0.0.0 port is still reachable globally. For full security, launch SlothForge with --secure to expose only this HTTPS link.",
    ...
    about: {
      ...
      studioVersion: "SlothForge Version",
      ...
      shutDownStudio: "Shut down SlothForge",
      shutDownStudioDescription:
        "Stops the SlothForge server and ends your session.",
      shutDown: "Shut down",
      update: {
        title: "Update SlothForge",
        commandText: "{label} text",
        copied: "Copied",
        copyCommand: "Copy command",
        commandCopied: "{label} copied",
        copyNamedCommand: "Copy {label}",
        checkingInstall: "Checking how SlothForge was installed...",
        installIntro: "To install or update SlothForge:",
        ...
        restartAfterUpdate: "Restart SlothForge after updating.",
        desktopManaged:
        ...
        desktopCurrentDescription:
          "SlothForge will continue checking automatically.",
        ...
        unknownInstall:
          "Could not detect how SlothForge was installed. For installer or PyPI installs, use the commands above.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "SlothForge couldn't confirm whether training started. Checking status in the background.",
