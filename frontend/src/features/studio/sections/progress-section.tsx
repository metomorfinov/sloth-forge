  ...
  const configItems: ConfigGroup[] = [
    {
      ...
      rows: [
        ...
        configRow(
          "Device",
          (cfg as RunConfigOverride | undefined)?.targetDevice ??
            (cfg as RunConfigOverride | undefined)?.device ??
            "AMD Radeon RX 570 (RADV POLARIS10)",
        ),
        configRow(
          "Backend",
          (cfg as RunConfigOverride | undefined)?.backend ??
